...
$('#styleSelector').append('' +
    ...
    '<ul>' +
        '<li>' +
            '<p class="selector-title main-title st-main-title"><b>Personalizar</b> Panel</p>' +
        '</li>' +
        '<li>' +
            '<p class="selector-title">Fondo Menu Vertical</p>' +
        '</li>' +
        '<li>' +
    ...
    '<div class="style-cont m-t-10">' +
        '<ul class="nav nav-tabs  tabs" role="tablist">' +
            '<li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#sel-layout" role="tab">Diseño</a></li>' +
        '</ul>' +
                    ...
                    '<li class="theme-option">' +
                        '<div class="checkbox-fade fade-in-primary">' +
                            '<label>' +
                                ...
                                '<span class="cr"><i class="cr-icon feather icon-check txt-success f-w-600"></i></span>' +
                                '<span>Fijar Posición del Encabezado</span>' +
                            '</label>' +
                        '</div>' +
                    '</li>' +
                '</ul>' +
        ...
        '<ul>' +
            ...
            '</li>' +
            '<li>' +
                '<p class="selector-title">Color de Seccion Seleccionada</p>' +
            '</li>' +
            '<li class="theme-option">' +
                '<div class="theme-color">' +
