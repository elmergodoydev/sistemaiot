...
$(document).ready(function() {
	...
	if(document.getElementsByName("js-small")){
	...
	/*
	elemsingle.onchange = function() {
		var valorCheck = elemsingle.checked;
		var tituloAlerta;
		var estado_cambiar;
		var periodo = $("#SelectPeriodoFuaGenerada").val();
		if(valorCheck == false){
			tituloAlerta = 'Desea Deshabilitar la Generacion de FUAS para todos los Establecimientos?';
			estado_cambiar = 0;
		}else{
			tituloAlerta = 'Desea Habilitar la Generacion de FUAS para todos los Establecimientos?';
			estado_cambiar = 1;
		}
