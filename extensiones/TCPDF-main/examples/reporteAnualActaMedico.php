...
$bloque2 = <<<EOD
    ...
    <table style="font-size:10px; padding:5px 10px;">
        ...
        <tr>
             ...
             <td style="border:1px solid #666; background-color:white; width:435px;">Año Seleccionado: $year</td>
             <td style="border:1px solid #666; background-color:white; width:435px;">Fecha Impresión: $DateAndTime </td>
        </tr>
