...
require_once '../../../controllers/ReporteActividadAfiliacionController.php';
require_once '../../../models/ReporteActividadAfiliacionModel.php';
...
$resp_usuario = UsuarioController::ctrMostrarUsuario("CAT_DIGITADOR","DOCUMENTO",$user);
$nombre_usuario = $resp_usuario['NOMBRES'];
$documento_usuario = $resp_usuario['DOCUMENTO'];
...
class MYPDF extends TCPDF {
	...
	public function LoadDataMotivoAte($fechaInicio, $fechaFin, $year, $user) {
		// Read file lines
        $resultado = ReporteActividadAfiliacionController::mostrarReporteMotivoAteCtr($fechaInicio, $fechaFin, $year, $user);
...
$bloque1 = <<<EOD
    ...
    <table>
        ...
        <tr>
            <td style="text-align:center;font-size: 10px; border:1px solid #666; background-color:white; width:560px;">REPORTE DE PRODUCCION DEL PERSONAL - OFICINA DE SEGUROS</td>
        </tr>
        ...
        <tr>
            ...
            <td style="border:1px solid #666; background-color:white; width: 160px; font-size: 8.5px; text-align:left; line-height: 13px;">
...
$bloque2 = <<<EOD
    ...
    <table style="font-size:10px; padding:5px 10px;">
        <tr>
            <td style="border:1px solid #666; background-color:white; width:330px">Usuario: $nombre_usuario</td>

            <td style="border:1px solid #666; background-color:white; width:230px; text-align:left;">Documento: $documento_usuario</td>

        </tr>


        <tr>
             <td style="border:1px solid #666; background-color:white; width:200px;">Tipo Reporte: $tipo_reporte </td>
             <td style="border:1px solid #666; background-color:white; width:100px;">Año: $year </td>
             <td style="border:1px solid #666; background-color:white; width:260px;">Fecha Impresión: $DateAndTime </td>
        </tr>
...
$bloque3 = <<<EOD
    ...
    <table style="font-size:12px; padding:5px 10px;">
        ...
        <tr>
         <td style="background-color:white; width:560px;">

            Cuadro N° 1 - Registros por Tipo de Atención Realizada
...
// column titles
$header = array('Tipo Atención', 'Cantidad');

// data loading
$data = $pdf->LoadDataMotivoAte($fechaInicio, $fechaFin, $year, $user);
