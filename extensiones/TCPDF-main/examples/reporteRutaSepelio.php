...
$derivaciones = SepelioControlador::mostrarReporteRuta($id_hash);
...
$bloque1 = <<<EOD
    ...
    <table style="padding:5px 10px;" >
        ...
        <tr>
            <td style="text-align:center;font-size: 12px; border:1px solid #666; background-color:white; width:870px;">HOJA DE RUTA - MÓDULO SEPELIOS</td>
        </tr>
...
$tabla_ruta .='<table>
                 <tr>
                    <th style="background-color:#bde0fe; text-align:center; border:1px solid #666; width:70px; font-size: 10px; padding: 4px;">AREA ENVIA<br></th>
                    <th style="background-color:#bde0fe; text-align:center; border:1px solid #666; width:110px; font-size: 10px; padding: 4px;">USUARIO ENVIA<br></th>
                    <th style="background-color:#bde0fe; text-align:center; border:1px solid #666; width:70px; font-size: 10px; padding: 4px;">AREA DESTINO<br></th>
                    <th style="background-color:#bde0fe; text-align:center; border:1px solid #666; width:110px; font-size: 10px; padding: 4px;">USUARIO DESTINO<br></th>
                    <th style="background-color:#bde0fe; text-align:center; border:1px solid #666; width:120px; font-size: 10px; padding: 4px;">FECHA ENVIO<br></th>
                    <th style="background-color:#bde0fe; text-align:center; border:1px solid #666; width:110px; font-size: 10px; padding: 4px;">DOC. REFERENCIA<br></th>
                    <th style="background-color:#bde0fe; text-align:center; border:1px solid #666; width:50px; font-size: 10px; padding: 4px;">FOLIOS<br></th>
                    <th style="background-color:#bde0fe; text-align:center; border:1px solid #666; width:100px; font-size: 10px; padding: 4px;">ESTADO<br></th>
                    <th style="background-color:#bde0fe; text-align:center; border:1px solid #666; width:120px; font-size: 10px; padding: 4px;">OBSERVACIONES<br></th>

                </tr>';

    foreach($derivaciones as $key => $value){

        $tabla_ruta .= '<tr>

                         <td style="background-color:white; border:1px solid #666; width:70px; font-size: 10px;">'.$value['CARGO_PERSONAL_ENVIA'].'<br></td>
                         <td style="background-color:white; border:1px solid #666; width:110px; font-size: 10px;">'.$value['PERSONAL_ENVIA'].'-'.$value['NOMBRE_ENVIA'].'<br></td>
                         <td style="background-color:white; border:1px solid #666; width:70px; font-size: 10px;">'.$value['CARGO_PERSONAL_DESTINO'].'<br></td>
                         <td style="background-color:white; border:1px solid #666; width:110px; font-size: 10px;">'.$value['PERSONAL_DESTINO'].'-'.$value['NOMBRE_DESTINO'].'<br></td>
                         <td style="background-color:white; border:1px solid #666; width:120px; font-size: 10px;">'.substr($value['FECHA_ENVIO'],0,19).'<br></td>
                         <td style="background-color:white; border:1px solid #666; width:110px; font-size: 10px;">'.$value['DOC_REFERENCIA'].'<br></td>
                         <td style="background-color:white; border:1px solid #666; width:50px;  font-size: 10px;">'.$value['FOLIOS_ENVIADOS'].'<br></td>
                         <td style="background-color:white; border:1px solid #666; width:100px; font-size: 10px;">'.$value['ESTADOS'].'<br></td>
                         <td style="background-color:white; border:1px solid #666; width:120px; font-size: 10px;">'.$value['OBSERVACIONES'].'<br></td>
